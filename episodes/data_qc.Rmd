...
# Install packages for omics_data_qc
install.packages(c('tidyverse', 'ggrepel', 'BiocManager'))
...
```{r echo=FALSE}
# Base project directory.
base_dir  = './sbgenomics/workspace' # use this path with "./" when working
                                     # in Workbench repo episodes directory
```
