...
tissue_abbrev <- load('data/tissue_abbrev.Rdata')
assay_abbrev <- load('data/assay_abbrev.Rdata')
metab_norm_data_flat <- load('data/metab_norm_data_flat.Rdata')
immuno_norm_data_flat <- load('data/immuno_norm_data_flat.Rdata')
outliers <- load('data/outliers.Rdata')
available_data <- load('data/available_data.Rdata')
